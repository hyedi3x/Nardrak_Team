...
<div class="wrap">
   <div class="container">
      ...
      <form name="inputform" action="${path}/addLocationDetailAction.tr" method="post" enctype="multipart/form-data" onsubmit="return submitChk()">
           
           <table>
               <tr class="width100">
                   <th>여행지 이름</th>
                   <td>
                       <input type="text" id="local_title" name="local_title" maxlength="30" placeholder="여행지 이름" oninput="checkTitle('${path}','#titileChk','#local_title');" required autofocus> 
                       <div id="titileChk"></div>
                   </td>
               </tr>
           ...
           <!-- 키워드 검색창 추가 -->
            ...
            var ps = new kakao.maps.services.Places();
             ...
             // 버튼 클릭하면 키워드가 전달되며 data의 첫 값만 사용
