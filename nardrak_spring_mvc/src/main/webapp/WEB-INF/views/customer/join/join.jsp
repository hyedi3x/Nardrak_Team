                            ...
                            <form name="inputform" action="joinAction.do" method="post" onsubmit="return signlnCheck()">
                                ...
                                <table>
                                    <tr>
                                        <th> * 아이디 </th> 
                                        <td>
                                            <input type="text" style="width:240px" class="input" name="cs_id" size="30" placeholder="공백없이 10자 이내로 작성" oninput="checkId(this.value)" required autofocus> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="position: relative;">
                                                <input type="password" style="width:350px" class="input" name="cs_pwd" id="cs_pwd" size="20" placeholder="영문,특수문자 포함 8자 이상" required oninput="checkPasswordStrength(this.value)">
                                                <i id="togglePassword" class="fa fa-eye" style="position: absolute; left: 330px; top: 50%; transform: translateY(-50%); cursor: pointer;" onclick="PasswordOne()"></i>
                                            </div>
                                            <br>
                                            <div id="pwdStrength" style="display:none; margin-top: 5px;"></div>
                                    ...
                                    <tr>
                                        <th> * 비밀번호 확인 </th>
                                        <td>
                                            <input type="password" style="width:350px" class="input" name="re_cs_pwd" id="re_cs_pwd" size="20" placeholder="비밀번호 재확인필요" required oninput="checkPasswordMatch()">
                                            <br>
                                    ...
                                    <tr>
                                        <th> * 이름 </th>
                                        <td>
                                            <input type="text" style="width:350px" class="input" name="cs_name" size="50" placeholder="이름 작성" required>
                                            <br>
                                    ...
                                    <tr>
                                        <th> * 전화번호 </th>
                                        <td>
                                            <select class="input" name="user_hp1" style="width:109px">
                                            ...
                                            -
                                            <input type="text" class="input" name="user_hp2" size="4" style="width:109px">
                                            -
                                            <input type="text" class="input" name="user_hp3" size="4" style="width:109px"> 
                                            <br>
                                    ...
                                    <tr>
                                        <th> 지역 전화번호 </th> 
                                        <td>
                                            <select class="input" name="user_local1" style="width:107px">
                                                <option value="0"> 선택 </option>
                                            ...
                                            -
                                            <input type="text" class="input" name="user_local2" size="4">
                                            -
                                            <input type="text" class="input" name="user_local3" size="4"> 
                                            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" id="sample4_roadAddress" style="width:350px" name="road" placeholder="도로명주소" required>
                                            <input type="text" id="sample4_jibunAddress" style="width:350px" name="jibun"  placeholder="지번주소">
                                            <span id="guide" style="color:#999;display:none"></span>
                                            <input type="text" id="sample4_detailAddress" style="width:174px" name="detail" placeholder="상세주소">
                                            <input type="text" id="sample4_extraAddress" style="width:173px" name="extra" placeholder="참고항목">
                                            <br>
                                    ...
                                    <tr>
                                        <th> * 이메일 </th>
                                        <td>
                                            <input type="text" class="input" name="user_email1" size="30" style="width:165px" required>
                                            <span class="em">@</span>
                                            <input type="text" class="input" name="user_email2" size="30" style="width:165px" required>
                                            <br>
                                            <div class="red hide" id="emailChk" style="display:none">
                                                <div class="font14" style="color:red;">올바른 이메일 형식으로 입력해주세요.</div>
                                            </div>
                                            <select class="input" name="user_email3" style="width:165px; margin-left: auto;" onchange="selectEmailChk()">
